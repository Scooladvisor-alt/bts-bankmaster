    ...
    <div style="font-family:'Nunito',Arial,sans-serif;max-width:600px;margin:0 auto;color:#1a1a1a;">
      ...
      <div style="background:white;padding:24px;border-radius:0 0 16px 16px;box-shadow:0 4px 20px rgba(0,0,0,0.08);">
        ...
        <div style="text-align:center;margin-top:32px;">
          <a href="https://btsbanque.fr" style="display:inline-block;background:#4ade80;color:white;font-weight:800;text-decoration:none;padding:14px 32px;border-radius:12px;font-size:16px;border-bottom:4px solid #16a34a;">
            ✨ Réviser maintenant →
          </a>
        </div>
